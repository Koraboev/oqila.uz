jQuery(document).ready(function () {
    ...
    jQuery("#rbkeyword_more").click(function () {
        jQuery("#rbkeyword_keywords").html('');
        e = 0;
            ...
            "https:" === location.protocol && (y = "https://suggestqueries.google.com/complete/search?output=toolbar&hl=en&q=" + rbkeyword_google), jQuery.get(y, "output=json&q=" + t + "&client=firefox", function (e) {
                ...
                if (0 == r.length) ; else {
                    ...
                    for (var o = 0; o < r.length; o++) {
                        console.log(o);
                        jQuery("#rbkeyword_keywords").append('<label class="wp_keyword_tool_itm "><input type="checkbox" value="' + r[o] + '">' + r[o] + "</label><br>"); 
                        jQuery(".rbkeyword_count").html(jQuery("label.wp_keyword_tool_itm").length);
                    }
                }
            }, "jsonp")
        }
