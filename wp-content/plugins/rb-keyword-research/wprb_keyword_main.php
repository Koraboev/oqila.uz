...
<select name="google">
    <option value="google.uz" <?php echo ($option_value === '') ? 'selected' : ''?>>Select One</option>
    <option value="google.uz" <?php echo ($option_value === 'google.uz') ? 'selected' : ''?>>Uzbekistan</option>
